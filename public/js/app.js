...
__webpack_require__(/*! ./chiptuning */ "./resources/js/chiptuning.js");
...
var homePage = 'http://localhost/chiptuning/';
var document = $(document);
var body = $("body");
var brandsId = "#brands";
var modelsId = "#models";
var generationsId = "#generations";
var motortypesId = "#motortypes";
var brandsList = $(brandsId);
var modelsList = $(modelsId);
var generationsList = $(generationsId);
var motorsList = $(motortypesId);
var modelsListText = "Kies uw model";
var generationsListText = "Kies uw generatie";
var motorsListText = "Kies uw motortype";
var form = "#chiptuningForm";
var brand;
var model;
var generation;
var motortype;
...
function getModels(slag) {
  var promise = makePromise("models/".concat(slag));
  return JSON.parse(promise.responseText);
}
...
function setModels(list) {
  ...
  var selected = list.length === 1;
  $.each(list, function (index, model) {
...
function getGenerations(slag) {
  var promise = makePromise("generations/".concat(brand, "/").concat(slag));
  return JSON.parse(promise.responseText);
}
...
function setGenerations(list) {
  ...
  resetOptions(motorsList, motorsListText);
  var selected = list.length === 1;
  $.each(list, function (index, generation) {
...
function getMotortypes(slag) {
  var promise = makePromise("motortypes/".concat(brand, "/").concat(model, "/").concat(slag));
  return JSON.parse(promise.responseText);
}
...
function setMotortypes(list) {
  resetOptions(motorsList, motorsListText);
  var selected = list.length === 1;
  $.each(list, function (index, motor) {
...
function setUrlSelected() {
  var currentVal = brandsList.attr('data-current');
...
body.on("change", brandsId, function (e) {
  var slag = e.target.value;
  brand = slag;
...
body.on("change", modelsId, function (e) {
  var slag = e.target.value;
  model = slag;
...
body.on("change", generationsId, function (e) {
  var slag = e.target.value;
  generation = slag;
...
body.on('submit', form, function (e) {
  ...
  if (generation !== 'none') {
    url += "/".concat(generation);
  }

  if (motortype !== 'none') {
    url += "/".concat(motortype);
  }
